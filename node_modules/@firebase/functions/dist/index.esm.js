...
import { FirebaseError, getModularInstance, getDefaultEmulatorHost } from '@firebase/util';
...
function getFunctions(app, regionOrCustomDomain) {
    ...
    var functionsEmulatorHost = getDefaultEmulatorHost('functions');
    if (functionsEmulatorHost) {
        var _a = functionsEmulatorHost.split(':'), host = _a[0], port = _a[1];
